...
computations that can update efficiently in response and up to their inputs.
Incremental can be useful in a number of applications as including:
...
- Constructing views in GUI applications that can incorporate new data
  efficiently.
- Building online versions of existing combinatorial and combination algorithms.

You can find detailed documentation in of the library and how to use
it in [[../incremental_kernel/blob/master/src/incremental_intf.ml][incremental_kernel/src/incremental_intf.ml]].  You can also find an informal induction.
